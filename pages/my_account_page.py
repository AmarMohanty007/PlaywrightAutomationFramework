...
class MyAccountPage:
    ...
    def __init__(self, page: Page):
        ...
        self.txt_visible = page.locator("h1:has-text('Account Logout')")
    ...
    def get_logout_text_visible_(self):
        try:
            return self.txt_visible
        except Exception as e:
            print(f" Exception while fetching 'Logout Text' locator: {e}")
            return None
